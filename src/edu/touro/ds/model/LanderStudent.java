...
/**
 * A LanderStudent is a specialization of a Person, that is Male, and has
 * a particular natural sort order. Some convenience methods are provided as well.
 */
public class LanderStudent extends Person implements Comparable<LanderStudent> {
    ...
    // Inconsistent code below to be examined TODO


    public boolean equals(Object obj) {
        if (obj == null) return false;
        if (obj instanceof LanderStudent) {
            LanderStudent another = (LanderStudent) obj;
